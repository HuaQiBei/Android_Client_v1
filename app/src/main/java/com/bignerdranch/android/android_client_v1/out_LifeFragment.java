...
public class out_LifeFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Log.d("test", "out_LifeFragment onCreateView");
        View view = inflater.inflate(//android.R.layout.simple_list_item_1,
                R.layout.outfragment_life,
                container, false);
        return view;
    }
	...
	public void onResume() {
		Log.d("test","out_LifeFragment onResume");
		super.onResume();
		updateUI();
	}
	...
	@Override
	public void onStop() {
		Log.d("test","out_LifeFragment onStop");
		super.onStop();
	}
